...
impl Drawable for Sphere {
    ...
    fn scatter(&self, ray: &Ray, hit_info: &mut HitInfo) {
        hit_info.normal_norm = ray.at(hit_info.t) - self.center;
        hit_info.normal_norm /= self.radius;
        hit_info.front_face = Vector3d::dot_product(ray.direction, hit_info.normal_norm) <= 0.0;
